...
- **bin/helix.js**: Copy SKILL.md to skill root during registration (Claude Code requires SKILL.md at `~/.claude/skills/helix/SKILL.md`)
...
- Rewrite bin/helix.js using array.join() to fix syntax errors with Unicode in template literals

## [1.1.2] - 2026-05-06

### Added

- `/helix:` prefix slash commands (replacing colon-based commands)
- `/helix:dev <需求>` as primary entry point for auto-start

## [1.1.1] - 2026-05-06

### Fixed

- Trigger on tags (v*) instead of main branch
...
- Remove Display package info step causing shell syntax error in GitHub Actions
- Remove unnecessary npm install step (no dependencies)
